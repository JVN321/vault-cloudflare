...
# echo "2. Enrolling face using the uploaded image key..."
# ENROLL_RESPONSE=$(curl -s -X POST "${API_URL}/api/v1/users/enroll-face" \
#   -H "Content-Type: application/json" \
#   -d "{\"name\": \"Test User $(date +%s)\", \"objectKey\": \"${OBJECT_KEY}\"}")
